...
parser.add_argument('--dir0', type=str, default="D:/Github-Code/BMNet-main/LOL/lolallstage/high")
parser.add_argument('--dir1', type=str, default="D:/Github-Code/BMNet-main/LOL/lolallstage/low")
...
for file in files:
    ...
    try:
        ...
        print('%s: %.6f' % (file, current_lpips_distance))
...
print("The processed images is ", i, "and the average_lpips_distance is: %.6f" % average_lpips_distance)